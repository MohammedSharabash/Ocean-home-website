...
namespace Talabatak.Helpers
{
    public  class Notifications
    {
        ...
        //Android
        private static string UserServerKey = "";
        private static string UserSenderId = "";

        private static string DriverServerKey = "";
        private static string DriverSenderId = "";
        ...
        public Notifications(AppDbContext db)
        {
            this.db = db;
        }
        ...
        {
            var users = db.PushTokens.Where(d => d.OS == OS.Android && d.UserId == UserId && d.IsWorker == IsDriver && d.IsDeleted == false).ToList();
