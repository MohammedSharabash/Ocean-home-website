jQuery(document).ready(function ($) {
    ...
    // added by carrot media
    $('#team_about .col-team').each(function (i) {
    ...
    $(document).on('click', '.wpb_image_grid_ul', function () {
        $('#ProjectGalleryImageGridToHide').hide();
        $('#ProjectGalleryImageGridToHidden').show();
